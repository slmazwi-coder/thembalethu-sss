          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0">
                <span className="md:hidden text-sm font-bold text-[#800000] block leading-tight">Thembalethu SSS</span>
                <span className="hidden md:block text-base font-bold text-[#800000] leading-tight">Thembalethu Senior Secondary School</span>
                <span className="text-xs font-semibold tracking-wide uppercase text-[#800000]/70">Progress Begins Here</span>
              </div>
            </Link>
            <div className="hidden md:flex items-center gap-3 shrink-0">
              <Link to="/student/login" className="px-4 py-2 rounded-lg text-sm font-bold text-[#800000] border border-[#800000] hover:bg-[#800000] hover:text-white transition">
                <User size={15} className="inline mr-1" /> Student Portal
              </Link>
            </div>
            <div className="md:hidden flex items-center shrink-0 ml-2">
              <button onClick={() => setIsOpen(!isOpen)} className="text-[#800000] hover:text-[#800000]/70 p-2" aria-label="Open menu">
