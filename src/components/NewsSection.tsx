    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-10">
          <h2 className="text-3xl font-bold text-school-blue flex items-center gap-2">
            <Bell className="text-yellow-500" /> News & Notices
          </h2>
          <button className="text-school-blue font-semibold hover:underline">View All</button>
        </div>
        ...
        {notices.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {notices.map((notice) => (
              <div key={notice.id} className="card flex flex-col h-full border-l-4 border-l-school-blue">
                ...
                <button className="text-school-blue font-medium flex items-center gap-1 hover:gap-2 transition-all">
