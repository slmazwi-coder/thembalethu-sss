  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={() => setShowUpload(!showUpload)} className="flex items-center gap-2 bg-school-blue text-white px-4 py-2 rounded-xl font-medium hover:bg-green-800">
